# -*- coding: utf-8 -*-
"""
Created on Thu Oct 17 03:20:07 2019
...
def maxfeatures(X_train, X_test, y_train, y_test):
    mf=[1,2,3,4]
    rms_test=[]
    rms_train=[]
    
    for i in mf:
        regressor = RandomForestRegressor(n_estimators = 10, random_state = 0,max_features=i)
    ...
    plt.plot(mf,rms_test, color = 'blue',label="test")
    plt.plot(mf,rms_train, color = 'red',label="train")
