# -*- coding: utf-8 -*-
"""
Created on Thu Dec 19 12:06:08 2019
...
for i in dist:
    regressor = KNeighborsRegressor(n_neighbors=2,weights=i)
...
plt.plot([0,1],rms_test, color = 'blue',label="test")
plt.plot([0,1],rms_train, color = 'red',label="train")
plt.legend(loc="center right")
plt.title('weights (KNeighborsRegressor)')
plt.xlabel('weights["uniform", "distance]"')
